...
AGT_second_dll agt_status_t dll::initSecondLibrary(agt_config_t parent, agt_ctx_t& secondCtx) noexcept {
...
AGT_second_dll agt_status_t dll::closeSecondLibrary(agt_ctx_t firstCtx) noexcept {
