...
namespace agt {
  ...
  // A deadline of 0 is indefinite
  void block_agent(basic_executor* executor, agent_self* self, agt_timestamp_t deadline) noexcept;
  ...
  // A deadline of 0 is indefinite
  agt_status_t executor_wait(basic_executor* executor, agent_self* self, async& async, agt_timestamp_t deadline) noexcept;
