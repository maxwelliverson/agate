...
AGT_first_dll agt_status_t dll::initFirstLibrary(agt_config_t parent, bool allowOverride, agt_ctx_t& firstCtx, agt_ctx_t& thirdCtx) noexcept {
...
AGT_first_dll  agt_status_t dll::closeFirstLibrary(agt_ctx_t firstCtx) noexcept {
